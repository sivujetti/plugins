 ...
 *
 * @psalm-type RadioGroupInputDetails = array{radios: array<int, object{text: string, value: string}>}
 * @psalm-type SelectInputDetails = array{options: array<int, object{text: string, value: string}>, multiple: bool}
...
interface BehaviourExecutorInterface {
     ...
     * @param array<array{result: mixed|\Exception, executor: cls-string, isError: bool}> $runResultsArr Values returned from the previous behaviours' run()s
